...
# ============================================================
# НОВЫЙ HTML — ПОЛНОСТЬЮ ПЕРЕРАБОТАННЫЙ
# ============================================================
...
// НЕТ ФУНКЦИИ addSources – источники НЕ показываются
...
async function sendMessage(){
    ...
    try {
        ...
        if (response.status === 402) {
            ...
            // НЕ вызываем addSources – источники скрыты
...
def chat(data: ChatRequest, request: Request):
    ...
    return {
        "answer": answer,
        "sources": sources,  // это поле есть, но на фронтенде оно не используется
